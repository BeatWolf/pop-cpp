 ...
 */
std::string uds_allocator_interconnector::allocate(const std::string& objectname, const paroc_od& od) {
 ...
 */
paroc_combox* uds_allocator_interconnector::allocate_group(const std::string& objectname, const paroc_od& od, int nb) {
