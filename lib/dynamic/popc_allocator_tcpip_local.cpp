 ...
 */
std::string socket_allocator_local::allocate(const std::string& objectname, const paroc_od& od) {
    std::string codefile;
 ...
 */
paroc_combox* socket_allocator_local::allocate_group(const std::string& objectname, const paroc_od& od, int nb) {
