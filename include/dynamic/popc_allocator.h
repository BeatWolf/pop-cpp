...
public:
    ...
    virtual std::string allocate(const std::string& objectname, const paroc_od& od) = 0;
    virtual paroc_combox* allocate_group(const std::string& objectname, const paroc_od& od, int nb) = 0;
